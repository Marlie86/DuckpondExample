...
/// <summary>
/// Command to update a group with its members and permissions.
/// </summary>
public class UpdateGroupWithMembersAndPermissionsCommand : IRequest<UpdateGroupWithMembersAndPermissionsResult>
{
    /// <summary>
